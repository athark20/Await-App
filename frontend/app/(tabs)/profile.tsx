    ...
    <View style={styles.root} testID="profile-screen">
      <ScrollView contentContainerStyle={[styles.content, { paddingTop: insets.top + 12, paddingBottom: bottomChrome + 24 }]}>
        ...
        <Group>
          ...
          <ListRow testID="profile-templates-row" icon="repeat-outline" tone="brand" title="Recurring Awaits" subtitle="Templates that recreate themselves on a schedule" onPress={() => router.push("/templates")} />
